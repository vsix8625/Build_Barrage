...
#define BARR_PROFILE_RET(fn, result)                                                                                   \
    ...
    {                                                                                                                  \
        ...
        clock_gettime(CLOCK_MONOTONIC, &end);                                                                          \
                                                                                                                       \
        barr_u64 ns =                                                                                                  \
            (barr_u64) (end.tv_sec - start.tv_sec) * 1000000000ULL + (barr_u64) (end.tv_nsec - start.tv_nsec);         \
        if (ns >= 1000000ULL)                                                                                          \
            BARR_log("[Profiler]%s → \033[34;1m(%.2f ms)", #fn, ns / 1000000.0);                                       \
        else if (ns >= 1000ULL)                                                                                        \
            BARR_log("[Profiler]%s → \033[34;1m(%.2f microsec)", #fn, ns / 1000.0);                                    \
        else                                                                                                           \
            BARR_log("[Profiler]%s → \033[34;1m(%.2f ns)", #fn, (double) ns);                                          \
    } while (0)
